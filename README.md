...
[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/smack-spring-boot-starter)](https://github.com/easy-4-java/smack-spring-boot-starter)
...
> **Artifact ID**：`smack-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**smack-spring-boot-starter** is a Spring Boot starter that integrates **smack** for applications using smack. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume smack capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using smack |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for smack |
| JDK | `17` |
| Coordinates | `io.github.easy4j:smack-spring-boot-starter:3.0.x.20260527-SNAPSHOT` |
| Config Prefix | `smack` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers smack beans automatically |
| Property Binding | ✅ Stable | Binds `smack.*` to `SmackProperties` |
| `SmackDebuggerFactory` bean | ✅ Stable | Auto-registered via SmackAutoConfiguration |
...
|---|---|---|
| `SmackDebuggerFactory` | classpath + property | not created |
| `XMPPTCPConnectionConfiguration` | classpath + property | not created |
...
|---|---|---|:---:|---|:---:|
| `smack.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl smack-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `smack.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/smack-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/smack-spring-boot-starter)
